package com.redli.meiqia.meiqia_flutter;
...
/** MeiqiaFlutterPlugin */
public class MeiqiaFlutterPlugin implements FlutterPlugin, MethodCallHandler, ActivityAware {
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
    channel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "meiqia_flutter");
